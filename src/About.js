...
const About = () => {
  return (
    <div className="about">
      <p>
        Why hello there! I see you've stumbled onto my page out of the billions
      ...
      <p>
        ...
        has elevated my technical skills immensely and you can see some of the
        larger projects I've been a part of. Thanks for the interest and don't
